...
var Audio = {
    ...
    info:{
        ...
        load:function(id,album,artist,title,albumart,mp3){
            ...
            totalTrack = $('.play-list a.play').length;
            currentTrack = $('.play-list a.play').index($('.play-list .active'))+1;
    ...
    player:function(){
        ...
        $('.progress').on('click',(event)=>{
            ...
            let e =$('.music') [0]
            let timelineWidth = 330
            let duration = e.duration;
            var skipTo = offsetX / timelineWidth;
            let currentTime = duration * skipTo;
            Audio.play($('.music'),currentTime);
        });
        $('.play-list .play').each(function(){
